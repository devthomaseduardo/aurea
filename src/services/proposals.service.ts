...
export const proposalsService = {
  ...
  createFromCalculation(
    ...
    const proposal: Proposal = {
      ...
      status: 'draft',
      currency: 'BRL',
      totalValue: result.custoTotal,
      totalHours: result.totalHoras,
      totalDays: result.totalDias,
      technologies: (project.tecnologias || []).filter((t) => t.selecionada).map((t) => t.nome),
      model,
