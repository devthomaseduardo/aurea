...
function Lazy({ children }: { children: React.ReactNode }) {
  return (
    <Suspense fallback={<LoadingState fullPage label="Carregando..." />}>
      {children}
    </Suspense>
  );
}
...
export function AppRoutes() {
  return (
    <AuthBootstrap>
      <Routes>
        <Route path={ROUTES.home} element={<Lazy><LandingPage /></Lazy>} />
        <Route path={ROUTES.about} element={<Lazy><AboutPage /></Lazy>} />

        <Route path={ROUTES.auth.login} element={<Lazy><LoginPage /></Lazy>} />
        <Route path={ROUTES.auth.register} element={<Lazy><RegisterPage /></Lazy>} />
        <Route path={ROUTES.auth.callback} element={<Lazy><AuthCallbackPage /></Lazy>} />

        <Route path={ROUTES.designSystem} element={<Lazy><DesignSystemPage /></Lazy>} />
        ...
        >
          ...
          <Route path="clients/new" element={<Lazy><ClientFormPage /></Lazy>} />
          <Route path="clients/:id" element={<Lazy><ClientFormPage /></Lazy>} />
          <Route path="calculator" element={<Lazy><CalculatorPage /></Lazy>} />
          <Route path="proposals" element={<Lazy><ProposalsPage /></Lazy>} />
          <Route path="proposals/:id" element={<Lazy><ProposalDetailPage /></Lazy>} />
